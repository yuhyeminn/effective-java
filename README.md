...
#### 10장. 예외
  - [아이템 69. 예외는 진짜 예외 상황에만 사용하라](https://github.com/yuhyeminn/effective-java/wiki/ITEM-69)
  - [아이템 70. 복구할 수 있는 상황에는 검사 예외를, 프로그래밍 오류에는 런타임 예외를 사용하라](https://github.com/yuhyeminn/effective-java/wiki/ITEM-70)
  - [아이템 71. 필요 없는 검사 예외 사용은 피하라](https://github.com/yuhyeminn/effective-java/wiki/ITEM-71)
  - [아이템 72. 표준 예외를 사용하라](https://github.com/yuhyeminn/effective-java/wiki/ITEM-72)
  - [아이템 73. 추상화 수준에 맞는 예외를 던지라](https://github.com/yuhyeminn/effective-java/wiki/ITEM-73)
  - [아이템 74. 메서드가 던지는 모든 예외를 문서화하라](https://github.com/yuhyeminn/effective-java/wiki/ITEM-74)
